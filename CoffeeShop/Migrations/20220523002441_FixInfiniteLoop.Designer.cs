...
namespace CoffeeShop.Migrations
{
    ...
    [Migration("20220523002441_FixInfiniteLoop")]
    partial class FixInfiniteLoop
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoffeeShop.Model.Orders", b =>
                {
                    b.HasOne("CoffeeShop.Model.Customers", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId");

                    b.HasOne("CoffeeShop.Model.Employees", "Employee")
                        .WithMany()
